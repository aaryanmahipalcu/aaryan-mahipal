...
export default function AboutPage() {
  ...
  return (
    <main className="min-h-screen bg-background text-foreground relative overflow-hidden">
      {/* Background Elements - Sunset Ocean Theme */}
      ...
      <div className="relative z-10">
        <div className="container mx-auto px-4 pt-20 pb-12">
          ...
          <AnimatedSection animation="fade-up">
            <div className="mb-12">
              <h2 className="text-3xl font-bold mb-4">/beyondwork</h2>
              <p className="text-lg text-muted-foreground max-w-2xl">
                here are some things that keep me inspired and energized outside of work
              </p>
            </div>
          </AnimatedSection>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-20">
            {[
              ...
              { icon: Utensils, label: "foodie", color: "text-orange-600" },
              { icon: Globe, label: "traveler", color: "text-cyan-600" }
            ].map((interest, index) => (
